...
from io_utils import model_dict, parse_args, get_resume_file, get_best_file , get_assigned_file, get_image_size
...
def run_test(params):
    ...
    with open(os.path.join(checkpoint_dir, 'results.txt'), 'a') as f:
        ...
        acc_str = '%d Test Acc = %4.2f%% +- %4.2f%%' %(iter_num, acc_mean, err)
...
if __name__ == '__main__':
    ...
    print(params)
    # Namespace(adaptation=False, dataset='CUB', method='baseline', model='Conv4', n_shot=5, save_iter=-1, split='novel', test_n_way=5, train_aug=False, train_n_way=5)
#     run_test(params)